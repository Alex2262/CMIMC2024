    ...
    def task4(self, q, queryOutputs): # p = 1 bd = 0.1
        ...
        if (q >= 33 or self.found == 0):
            ...
            for i in range(n):
                for j in range(n):
                    if (i == 0 and j == 0):
                        if (newPlan[i+1][j] == 0 and newPlan[i][j+1] == 0):
                            newPlan[i][j] = 0
                    elif (i == 0 and not j == n-1):
                        if (newPlan[i+1][j] == 0 and newPlan[i][j+1] == 0 and newPlan[i][j-1] == 0):
                            newPlan[i][j] = 0
                    elif (j == 0 and not i == n-1):
                        if (newPlan[i+1][j] == 0 and newPlan[i][j+1] == 0 and newPlan[i-1][j] == 0):
                            newPlan[i][j] = 0
                    elif (i == n-1 and j == n-1):
                        if (newPlan[i-1][j] == 0 and newPlan[i][j-1] == 0):
                            newPlan[i][j] = 0
                    elif (i == n-1 and not j == 0):
                        if (newPlan[i][j+1] == 0 and newPlan[i-1][j] == 0 and newPlan[i][j-1] == 0):
                            newPlan[i][j] = 0
                    elif (j == n-1 and not i == 0):
                        if (newPlan[i+1][j] == 0 and newPlan[i-1][j] == 0 and newPlan[i][j-1] == 0):
                            newPlan[i][j] = 0
                    elif (i == n-1 and j == 0):
                        if (newPlan[i][j+1] == 0 and newPlan[i-1][j] == 0):
                            newPlan[i][j] = 0
                    elif (i == 0 and j == n-1):
                        if (newPlan[i+1][j] == 0 and newPlan[i][j-1] == 0):
                            newPlan[i][j] = 0
                        ...
                        # print(i, j)
                        if (newPlan[i+1][j] == 0 and newPlan[i][j+1] == 0 and newPlan[i-1][j] == 0 and newPlan[i][j-1] == 0):
                            newPlan[i][j] = 0
                            # print("removed")
